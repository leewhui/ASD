...
<%
    ...
    int userID = cards[0].getUserID();
%>

<div class="container-fluid">
    <h1 class="w3-wide" align ="center" style=font-size:60px>
        Select Card<br/> Hi,User <%=userID%>
    </h1>
        ...
        <div class="carousel-inner row w-100 mx-auto">
            ...
            %>
                ...
                <div class="card">
                    ...
                    <img class="card-img-top img-fluid" src="resources/adultCard.png" alt="card-img">
                    <% } else if(cardType.equals("Child")){ %>
                    <img class="card-img-top img-fluid" src="resources/childCard.png" alt="card-img">
                    <% } else if(cardType.equals("Concession")){ %>
                    <img class="card-img-top img-fluid" src="resources/concessionCard.png" alt="card-img">
                    <% } else if(cardType.equals("Senior")){ %>
                    <img class="card-img-top img-fluid" src="resources/seniorCard.png" alt="card-img">
                    <% } %>
                    <div class="details">
