...
<div class="container">
    ...
    <form class="form" action="signupController" method="post">
        <div class="progress">
            <div id="progressBar" class="progress-bar" role="progressbar" aria-valuenow="75" aria-valuemin="0"
        ...
        <div class="pages" id="first">
            <div class="form-group" id="usernameArea">
                ...
                <input type="text" class="form-control" name="username" id="usernameBox" aria-describedby="emailHelp" required>
                <small id="usernameText" class="form-text text-warning"></small>
            </div>

            <div class="form-group">
                <label>Email address</label>
                <input type="email" class="form-control" name="email" id="emailBox" aria-describedby="emailHelp" required>
            ...
            <div class="form-group">
                ...
                <div class="input-group mb-3">
                    <input type="password" class="form-control" name="password" id="passwordBox" aria-label="Recipient's username"
        ...
        <div class="pages" id="second">
            ...
            <div id="app" class="dob form-group">
                ...
                <input id="flatpickr-tryme" class="form-control" data-max-date=today data-date-format="d-m-Y"
